      ...
      const res = await apiFetch('/tasks/register', {
        ...
        body: JSON.stringify({
          ...
          extra: {
            ...
            outlook_official_alias_mode: cfg.outlook_official_alias_mode,
            outlook_official_alias_prefix: cfg.outlook_official_alias_prefix,
            outlook_official_target_email: cfg.outlook_official_target_email,
            outlook_official_poll_interval: cfg.outlook_official_poll_interval,
            outlook_official_timeout: cfg.outlook_official_timeout,
          },
        }),
      })
